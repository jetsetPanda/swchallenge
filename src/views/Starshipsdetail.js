...
export default function Starshipsdetail(props) {
  ...
  return dataset.isLoading? (
    ...
    <div className="container">
      ...
      <Infobox name={'Hyperdrive Rating'} value={dataset.hyperdrive_rating} />  
      <Infobox name={'MGLT'} value={dataset.mglt} />
      <Infobox name={'Starship Class'} value={dataset.starship_class} />
